...
class CA_Model:
    def __init__(self, modelpath, p, m, nY, nU, steps):
        ...
        self.x_min = ca.DM(np.array([[3.3351778984069824],
                                     [5.387231826782227],
                                     [0.34086209535598755],
                                     [24502.779296875]]))
        self.x_max = ca.DM(np.array([[3.3351778984069824+9.230131149291992],
                                     [5.387231826782227+3.9142303466796875],
                                     [0.34086209535598755+0.3170139193534851],
                                     [24502.779296875+29185.841796875]]))
