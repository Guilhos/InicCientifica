...
def superPlot(iter_NN, Ymk_NN,
    ...
    plt.plot(x_NN / 2, YmMin_NN, linestyle="-.", color="black", label="Região de Operabilidade", linewidth=2.5)
    ...
    plt.plot(x_CA / 2, YmMin_CA, linestyle="-.", color="black", label="Região de Operabilidade", linewidth=2.5)
    ...
    plt.plot([0, iter_NN / 2], [5.27, 5.27], linestyle="-.", color="black", label="Região de Operabilidade", linewidth=2.5)
    ...
    plt.plot([0, iter_CA / 2], [5.27, 5.27], linestyle="-.", color="black", label="Região de Operabilidade", linewidth=2.5)
    ...
    plt.plot([0, iter_NN / 2], [0.35, 0.35], linestyle="-.", color="black", label="Região de Operabilidade", linewidth=2.5)
    ...
    plt.plot([0, iter_CA / 2], [0.35, 0.35], linestyle="-.", color="black", label="Região de Operabilidade", linewidth=2.5)
    ...
    plt.plot([0, iter_NN / 2], [27e3//60, 27e3//60], linestyle="-.", color="black", label="Região de Operabilidade", linewidth=2.5)
    ...
    plt.plot([0, iter_CA / 2], [27e3//60, 27e3//60], linestyle="-.", color="black", label="Região de Operabilidade", linewidth=2.5)
